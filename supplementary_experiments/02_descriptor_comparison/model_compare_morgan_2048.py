...
# Descriptor: Morgan 2048-bit Fingerprints
# Run with: tabpfgen conda environment
#   E:\miniconda\envs\tabpfgen\python.exe model_compare_morgan_2048.py
# ==============================
...
results_df.to_csv('morgan2048_benchmark_details.csv', index=False)
summary_df.to_csv('morgan2048_benchmark_summary.csv', index=False)
pd.DataFrame(best_params_dict).T.to_csv('morgan2048_best_params.csv')
