...
# Descriptor: Morgan 1024-bit Fingerprints
# Run with: tabpfgen conda environment
#   E:\miniconda\envs\tabpfgen\python.exe model_compare_morgan_1024.py
# ==============================
...
# 1. Load data
# ==============================
df = pd.read_excel('morgan_1024.xlsx')
...
results_df.to_csv('morgan1024_benchmark_details.csv', index=False)
summary_df.to_csv('morgan1024_benchmark_summary.csv', index=False)
pd.DataFrame(best_params_dict).T.to_csv('morgan1024_best_params.csv')
