...
print(f"SMOTE + StandardScaler + {n_cv_folds}-Fold CV Threshold | seeds={len(seeds)}")
...
# ==============================
print("\n" + "=" * 65)
print(f"SMOTE + StandardScaler + {n_cv_folds}-Fold CV Threshold (Mean +/- 95% CI)")
print("=" * 65)
print(df_summary.to_string(index=False))

output_file = "SMOTE_Scaled_with_TabPFN_ThresholdTuned.xlsx"
