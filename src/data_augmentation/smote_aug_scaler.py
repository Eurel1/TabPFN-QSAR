# ==============================
# SMOTE + StandardScaler + TabPFN Benchmark
# ==============================
...
models = {
    ...
    # ✅ 新增 TabPFN
    'TabPFN': TabPFNClassifier(device='cuda')  # 有GPU改为 'cuda'
}
...
print(f"开始多随机种子实验 (SMOTE + 归一化 + TabPFN)，共 {len(seeds)} 个种子...")

for seed in seeds:
    print(f"正在运行随机种子: {seed}...", end='\r')
    ...
    sampling_strategy = {class_label: 500 for class_label in unique_classes}
...
# ==============================
print("\n" + "=" * 50)
print("SMOTE + StandardScaler + TabPFN 性能汇总 (Mean ± 95% CI)")
print("=" * 50)
print(summary_df.to_string(index=False))

output_file = "benchmark_results_SMOTE_Scaled_with_TabPFN.xlsx"

with pd.ExcelWriter(output_file) as writer:
    summary_df.to_excel(writer, sheet_name="Summary_95CI", index=False)
